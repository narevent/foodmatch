...
# CONFIGURATION
PROJECT_NAME="foodmatch"                                    # Project name (used for directories and services)
PROJECT_DIR="/var/www/foodmatch"                            # Where to install the project
REPO_URL="https://github.com/narevent/foodmatch.git"       # GitHub repository URL
DOMAIN_NAMES="foodmatch.vetgaaf.tech"               # Space-separated domain names
PRIMARY_DOMAIN="foodmatch.vetgaaf.tech"                              # Primary domain (first one)
WSGI_MODULE="foodmatch.wsgi:application"                    # Django WSGI module (usually projectname.wsgi:application)
